            ...
            <div className=" background-div "> 
                <div className="flex flex-col items-center justify-center h-screen px-4 gap-2">
                    ...
                    <div className="flex flex-row items-center justify-center h-screen px-4 gap-10"> 
                        <div className="flex gap-y-2 flex-col  justify-center items-center border-none py-4 px-8 rounded-lg shadow-lg  bg-white w-[600px] h-[600px] flex flex-col justify-between">  
                            <p className="chatbot-message">Hello i am MathMentor how can i help u?</p>
                            <p className="chatbot-message">I can help you with math problems, explanations, and more!</p>
                            <p className="chatbot-message-user">Hello </p> 
                            <input type="text" 
                                    value={message.text} 
